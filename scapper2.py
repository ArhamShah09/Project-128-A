...
headers = ["Name", "Constellation", "Right_ascension", "Declination", "Discovery_year", "hyperlink", 
            "Spectral_type", "planet_radius", "orbital_radius", "orbital_period", "eccentricity"]
...
def scrape():
    for i in range(1,5):
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "dwarf"}):
